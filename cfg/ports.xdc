...
create_generated_clock -source [get_pins system_i/adc/adc_clk_p_i] -edges {1 2 9} [get_pins system_i/adc/axis_red_pitaya_adc_0/adc_clk]

set_property MARK_DEBUG false [get_nets {system_i/exp_avg_filter_order_0/U0/exp_avg_filter_inst/State_SP_reg[2][0]}]
set_property MARK_DEBUG false [get_nets {system_i/exp_avg_filter_order_0/U0/exp_avg_filter_inst/State_SP_reg[2][3]}]
set_property MARK_DEBUG false [get_nets {system_i/exp_avg_filter_order_0/U0/exp_avg_filter_inst/State_SP_reg[2][1]}]
set_property MARK_DEBUG false [get_nets {system_i/exp_avg_filter_order_0/U0/exp_avg_filter_inst/State_SP_reg[2][2]}]
